...
namespace gdwg {
	...
	private:
		...
		// std::map<std::shared_ptr<N>, std::set<std::pair<std::shared_ptr<N>, E>>, mapComparator>
		// graph_; std::map<std::shared_ptr<N>, std::set<std::shared_ptr<std::pair<std::shared_ptr<N>,
		// E>>>, mapComparator> graph_;
	};
} // namespace gdwg
